        ...
        if (manifestFile) {
            ...
            if (!manifest.shortcuts) {
                ...
                if (option === "Learn More") {
                    vscode.commands.executeCommand("vscode.open", vscode.Uri.parse("https://developer.mozilla.org/en-US/docs/Web/Manifest/shortcuts"));
                }
            }
            ...
            if (!manifest.display_override) {
                ...
                if (option === "Learn More") {
                    vscode.commands.executeCommand("vscode.open", vscode.Uri.parse("https://docs.microsoft.com/en-us/microsoft-edge/progressive-web-apps-chromium/how-to/window-controls-overlay"));
                }
            }
        }
    });
